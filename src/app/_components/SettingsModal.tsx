...
export default function SettingsModal() {
  ...
  return (
    <div id="settingsModal" className={settingsModal ? '' : 'hidden'}>
      ...
      <div className='z-10 translate-x-[-50%] flex justify-between flex-wrap absolute rounded-xl p-8 max-w-[500px] max-sm:w-[80vw] h-[60vh] bg-base-300 left-[50vw] top-[25vh]'>
