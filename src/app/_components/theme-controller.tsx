...
export default function ThemeController() {
  return (
    <div id="theme-controller" className="dropdown col-span-1 w-full mb-48">
      <div tabIndex={0} role="button" className="btn min-h-10 h-10 w-full">
        Theme
      ...
      <ul tabIndex={0} className="dropdown-content z-[1] p-2 shadow-2xl bg-base-300 rounded-box w-full">
        ...
        <li><input type="radio" name="theme-dropdown" className="theme-controller btn btn-sm btn-block btn-ghost justify-start" aria-label="Karala" value="karala" /></li>
      </ul>
    </div>
  )
}
